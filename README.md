...
**Live Application:** [https://skillsync-ai-project.web.app](https://skillsync-ai-project.web.app)
...
4.  Insert your own **Gemini** and **Groq** API keys into the `apiKeys` array.
5.  Update the `firebaseConfig` with your project credentials.
